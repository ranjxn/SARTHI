...
const TEST_RECIPIENTS = [
  { email: 'mohitraj8503@gmail.com', name: 'Mohit Raj' },
  { email: 'omprabhat21@gmail.com', name: 'Om Prabhat' },
];

async function sendKeshavOfferTest() {
...
We look forward to working with you and supporting your growth as a professional. Welcome aboard!`,
  ...
  console.log('\n🎉 Test send complete! Check both inboxes before sending to Keshav.');
}

sendKeshavOfferTest().catch((err) => {
