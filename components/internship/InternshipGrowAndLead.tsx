...
const TRACKS = [
  ...
  },
  {
    ...
    desc: 'Deploy live projects, write technical documentation, and showcase verified work to recruiters. Build confidence, visibility, and a distinct professional network.',
  },
  {
    tag: 'Real-World Impact',
    title: 'Deliver production code',
    desc: 'Bridge the gap between academic theory and real-world software engineering. Ship features, review PRs, and establish your career foundation before graduation.',
  },
];

export default function InternshipGrowAndLead() {
  return (
      ...
      <div className="container mx-auto max-w-[1500px]">
        ...
        <div className="text-left mb-16 max-w-xl">
          ...
          <p className="text-[#6B7280] text-sm md:text-base leading-relaxed">
            Expand your practical skillset, lead engineering tasks, and establish your professional brand before you graduate.
          </p>
        </div>
