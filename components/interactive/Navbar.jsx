    ...
    >
      <div className="container-large w-container">
        <div className="navbar-area">
          ...
          >
            <span style={{ fontFamily: '"Instrument Sans", Inter, system-ui, sans-serif', fontSize: '24px', fontWeight: '800', letterSpacing: '0.14em', color: '#ffffff', textTransform: 'uppercase' }}>
              SARTHI
            </span>
          </Link>
          <nav
