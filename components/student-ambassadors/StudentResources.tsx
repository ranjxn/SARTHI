...
import { Trophy, Compass, Library, Users } from 'lucide-react';
...
const RESOURCES = [
  ...
  },
  {
    icon: Compass,
    title: 'Student Hub',
    desc: 'Access our central portal for ambassador profiles, event submissions, leaderboard status, and announcements.',
  ...
  },
  {
    ...
    desc: 'Guides, curricula, and slide decks to help you host events, teach tech tracks, and run bootcamps.',
