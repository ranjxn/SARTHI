...
const TIERS = [
  {
    ...
    desc: 'Unlock premium SARTHI courses, certification exam vouchers, and cloud sandbox credits.',
  },
  {
    name: 'Beta',
    icon: Award,
    ...
    desc: 'Unlocks when you host your first campus event. Get our official physical swag kit, budget support, and regional mentor support.',
  },
  {
    name: 'Gold',
    icon: Crown,
    ...
    desc: 'Selected based on exceptional campus leadership. Gain regional lead status, speaker features, and direct recruiter interviews.',
  },
];
      ...
      <div className="max-w-[1500px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
        ...
        <div className="lg:col-span-1 text-left">
          ...
          <p className="text-[#6B7280] text-sm leading-relaxed mb-6">
            Progress through three distinct milestones by learning new tech skills and sharing them in campus events. Each tier unlocks additional benefits.
          </p>
        </div>
