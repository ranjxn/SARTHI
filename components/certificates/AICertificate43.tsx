...
export interface AICertificate43Props {
  studentName?: string;
  courseName?: string;
...
export default function AICertificate43({
  ...
  return (
    <>
      ...
      <div
        id="exact-ai-certificate-43-root"
        ...
        <div className="flex h-full flex-col justify-between">
          ...
          <div className="flex items-center justify-between mb-[2.5cqi]">
            <div className="flex items-center gap-[1.1cqi]">
              {/* Colorful Triangular SVG Logo */}
              <svg className="w-[3.8cqi] h-[3.8cqi]" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <path d="M50 15 L85 75 L15 75 Z" fill="url(#exactGrad1)"/>
                <path d="M50 15 L85 75 L50 85 Z" fill="url(#exactGrad2)" style={{ mixBlendMode: 'multiply' }}/>
                <path d="M15 75 L85 75 L50 85 Z" fill="url(#exactGrad3)" style={{ mixBlendMode: 'multiply' }}/>
                <defs>
                  <linearGradient id="exactGrad1" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" style={{ stopColor: '#DC6F51', stopOpacity: 1 }} />
                    <stop offset="100%" style={{ stopColor: '#8D327F', stopOpacity: 1 }} />
                  </linearGradient>
                  <linearGradient id="exactGrad2" x1="0%" y1="100%" x2="100%" y2="0%">
                    <stop offset="0%" style={{ stopColor: '#1A69A4', stopOpacity: 0.9 }} />
                    <stop offset="100%" style={{ stopColor: '#151A30', stopOpacity: 0.9 }} />
                  </linearGradient>
                  <linearGradient id="exactGrad3" x1="100%" y1="100%" x2="0%" y2="0%">
                    <stop offset="0%" style={{ stopColor: '#8D327F', stopOpacity: 0.8 }} />
                    <stop offset="100%" style={{ stopColor: '#DC6F51', stopOpacity: 0.8 }} />
                  </linearGradient>
                </defs>
              </svg>
          ...
          <div className="text-center mb-[2cqi]">
            ...
            <div className="mx-auto mt-[0.6cqi] flex w-[48cqi] items-center justify-center gap-[1.8cqi]">
              <div className="h-[1.5px] flex-grow bg-gradient-to-r from-transparent to-[#174A87]" />
              <span className="text-[1.7cqi] font-[500] tracking-[6px] text-[#151A30] uppercase">
                OF COMPLETION
              </span>
              <div className="h-[1.5px] flex-grow bg-gradient-to-r from-[#A03271] to-transparent" />
            </div>
          </div>
          ...
          <div className="text-center mb-[2.2cqi]">
            ...
            <h2
              className="my-[0.3cqi] text-[6.8cqi] font-[600] italic leading-tight text-transparent bg-clip-text bg-gradient-to-r from-[#1A69A4] via-[#8D327F] to-[#DC6F51]"
              style={{ fontFamily: "'Playfair Display', serif" }}
            >
              {studentName}
            </h2>
            <p className="mx-auto max-w-[650px] text-[1.35cqi] font-[500] leading-[1.8] text-[#5A5A5A]">
              has successfully completed a comprehensive course on <strong className="text-[#151A30] font-[700]">{courseName}</strong>,<br />
              covering core and advanced modules in machine learning, data analysis,<br />
          ...
          <div className="text-center mb-auto">
            <div className="relative mx-auto my-[1.8cqi] flex w-[28cqi] items-center justify-center">
              ...
              <div className="absolute w-[0.6cqi] h-[0.6cqi] rounded-full bg-[#F88A76]" />
            </div>
          ...
          <div className="flex items-end justify-between px-[3.5cqi]">
            ...
            <div className="flex flex-col items-center flex-1">
              <div className="mb-[1.2cqi] flex h-[4.2cqi] w-[4.2cqi] items-center justify-center rounded-[1.1cqi] border border-white/80 bg-white/60 shadow-[0_4px_10px_rgba(0,0,0,0.03)]">
                <svg className="w-[1.9cqi] h-[1.9cqi] stroke-[#8D327F]" viewBox="0 0 24 24" fill="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
