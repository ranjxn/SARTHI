...
export default function InternshipVerifyLandingPage() {
  ...
  const handleVerify = (e: React.FormEvent) => {
    ...
    setLoading(true);
    router.push(`/verify/interns/${encodeURIComponent(trimmed)}`);
  };
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (!data.certificates || data.certificates.length === 0) {
          setError('No internship certificates found for this email address.');
        }
      } else {
    ...
    <div className="induction-page-wrapper">
      ...
      <div className="induction-shell">
        ...
        <section className="induction-hero text-left">
          ...
          <h1 className="induction-title">Verify Internship Certificate</h1>
          <p className="induction-subtitle">
            Validate the authenticity of internship certifications issued by SARTHI. Enter your unique Certificate ID to verify credentials.
          </p>
        </section>
            ...
            <form onSubmit={handleVerify} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. TT-INT-2026-0038"
            ...
            <div className="mt-8 border-t border-gray-100 pt-6 space-y-3">
              ...
              <div className="space-y-2 max-h-60 overflow-y-auto pr-1">
                {certsList.map(c => (
                  <div
                    key={c.id}
                    onClick={() => router.push(`/verify/interns/${encodeURIComponent(c.certificateNumber || c.id)}`)}
